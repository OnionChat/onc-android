...
class MessageReadInfo(@PrimaryKey val id: String,  @ColumnInfo( index = true) val message_id: String, @ColumnInfo(name = "user_id") /* !! THE HASHED USERID !!*/ val userId: String, @ColumnInfo(name = "timestamp") val timestamp: Long)