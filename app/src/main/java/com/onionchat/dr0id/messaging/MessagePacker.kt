...
//    }
    ...
    fun decodeMessage(message: String): Message {
        ...
        val message: Message? = if (obj.has(MESSAGE_TEXT_MESSAGE)) {
    ...
    fun encodeMessage(message: Message, keyId: String): String {
        return encryptMessage(message, keyId); // TODO BASE64 !!
    }

    internal fun encryptMessage(message: Message, keyId: String): String {
