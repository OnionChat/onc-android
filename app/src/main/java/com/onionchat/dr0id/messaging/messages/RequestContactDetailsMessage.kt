...
class RequestContactDetailsMessage(
    val extraData: String = "empty", // currently unused
    ...
    read: Int = 0,
    type: Int = MessageTypes.REQUEST_CONTACT_DETAILS_MESSAGE.ordinal
) :
    SymmetricMessage(
        messageId,
        extraData.toByteArray(),
        hashedFrom,
        hashedTo,
        signature,
        messageStatus,
